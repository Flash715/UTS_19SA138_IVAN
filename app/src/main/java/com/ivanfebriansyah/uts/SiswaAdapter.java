...
public class SiswaAdapter extends ArrayAdapter<com.ivanfebriansyah.uts.Siswa> {
    Context mCtx;
    int listLayoutRes;
    List<com.ivanfebriansyah.uts.Siswa> siswaList;
    SQLiteDatabase mDatabase;

    public SiswaAdapter(Context mCtx, int listLayoutRes, List<com.ivanfebriansyah.uts.Siswa>siswaList, SQLiteDatabase mDatabase){
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        final com.ivanfebriansyah.uts.Siswa siswa = siswaList.get(position);
    ...
    private void lihatSiswa(com.ivanfebriansyah.uts.Siswa siswa) {
    ...
    private void updateSiswa(final com.ivanfebriansyah.uts.Siswa siswa){
        final AlertDialog.Builder builder = new AlertDialog.Builder(mCtx);
        ...
        view.findViewById(R.id.btnUpdate).setOnClickListener(new View.OnClickListener(){
            public void onClick(View view) {
                ...
                String nilaiAkhir = com.ivanfebriansyah.uts.Siswa.hitungNilaiAkhir(nilaikehadiran, nilaitugas, nilaiuts, nilaiuas);
    ...
    private void reloadSiswaFromDatabase() {
        ...
        if (cursorSiswa.moveToFirst()) {
            siswaList.clear();
            do {
                siswaList.add(new com.ivanfebriansyah.uts.Siswa(
