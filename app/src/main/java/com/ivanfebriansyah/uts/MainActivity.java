...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public static final String DATABASE_NAME = "UTS";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button hapus = (Button)findViewById(R.id.clear);

        hapus.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                editTextNama.getText().clear();
                editTextNomer.getText().clear();
                editTextKelas.getText().clear();
                editTextNilaiHadir.getText().clear();
                editTextNilaiTugas.getText().clear();
                editTextNilaiUTS.getText().clear();
                editTextNilaiUAS.getText().clear();
            }
        });
    ...
    private void hitungNilai(){
        ...
        if (nilaikehadiran.equals("") || nilaitugas.equals("") || nilaiuts.equals("") || nilaiuas.equals("")) {
            ...
            textViewHasilNilaiAkhir.setText(String.valueOf(total+" Grade : "+grade));
        }
    }
